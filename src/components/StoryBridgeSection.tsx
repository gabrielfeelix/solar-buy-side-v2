    ...
    <section className="bg-white text-slate-900 font-sans selection:bg-orange-100">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <header className="max-w-4xl mx-auto text-center mb-8">
          <h2 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 mb-8 leading-snug">
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-6 flex justify-center lg:justify-start">
            <img
              src={section?.images.manualImage || section?.images.manual || '/assets/Manual de Compra -OF.png'}
