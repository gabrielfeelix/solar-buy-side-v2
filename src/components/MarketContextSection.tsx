  ...
  return (
    <section className="py-32 bg-gradient-to-b from-black via-bg-primary to-bg-secondary relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4">
        {/* Contexto de Mercado */}
        <div className="glass-card p-8 sm:p-12 border-2 border-danger-red/30 mb-16 relative overflow-hidden group hover:border-danger-red/60 transition-all duration-300">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-text-primary text-center mb-4">
            ...
            <p className="text-xl text-text-primary text-center mb-8">
              ...
              você pode se <span className="text-neon-green font-bold">DESTACAR</span>.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="glass-card p-6 text-center border border-danger-red/30 hover:scale-105 transition-transform">
                <TrendingUp className="w-12 h-12 text-danger-red mx-auto mb-3" />
                <p className="text-4xl font-bold gradient-text-danger mb-2">+35%</p>
                <p className="text-sm text-text-secondary">Custo equipamentos</p>
                <p className="text-xs text-text-muted">(2024-2025)</p>
              </div>

              <div className="glass-card p-6 text-center border border-warning-orange/30 hover:scale-105 transition-transform">
                ...
                <p className="text-sm text-text-secondary">Taxa juros</p>
                <p className="text-xs text-text-muted">financiamento</p>
              </div>

              <div className="glass-card p-6 text-center border border-electric-cyan/30 hover:scale-105 transition-transform">
                <Users className="w-12 h-12 text-electric-cyan mx-auto mb-3" />
                <p className="text-4xl font-bold gradient-text mb-2">+58%</p>
                <p className="text-sm text-text-secondary">Integradores</p>
            ...
            <div className="bg-bg-primary/50 rounded-xl p-6 mb-6">
              <p className="text-xl text-text-primary font-bold mb-4 text-center">TRADUÇÃO:</p>
        ...
        <div className="grid md:grid-cols-12 gap-6 mb-16">
          ...
          <div className="md:col-span-7 glass-card p-8 border border-neon-green/30 hover:border-neon-green hover:shadow-neon-green transition-all duration-300 group">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto rounded-full bg-neon-green/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <ul className="space-y-3 text-left max-w-md mx-auto mb-6">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-text-secondary">Download instantâneo</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-neon-green flex-shrink-0" />
                  <span className="text-text-secondary">PDF otimizado para todos dispositivos</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-neon-green flex-shrink-0" />
                  <span className="text-text-secondary">Índice clicável</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-neon-green flex-shrink-0" />
                  <span className="text-text-secondary">Busca interna</span>
                </li>
              </ul>

              <div className="inline-block px-6 py-3 rounded-full bg-neon-green/20 border border-neon-green text-neon-green font-bold">
                Disponível 24/7
              </div>
            </div>
          </div>
          ...
          {/* Card 2 - Conteúdo */}
          <div className="md:col-span-5 glass-card p-8 border border-electric-cyan/30 hover:scale-105 transition-all duration-300 text-center">
            <span className="text-6xl mb-4 block">📘</span>
            <h3 className="text-3xl font-bold gradient-text mb-2">130 PÁGINAS</h3>
            <p className="text-lg text-text-secondary mb-4">TÉCNICAS</p>

            <div className="text-4xl font-bold text-text-primary my-4">+</div>

            <h3 className="text-3xl font-bold gradient-text mb-2">160 TÓPICOS</h3>
            <p className="text-lg text-text-secondary">INTERATIVOS</p>
          </div>

          {/* Card 3 - Metodologia */}
          <div className="md:col-span-5 glass-card p-8 border border-electric-cyan/30 hover:scale-105 transition-all duration-300 text-center">
            <span className="text-6xl mb-4 block">🎯</span>
            <h3 className="text-2xl font-bold text-text-primary mb-2">MÉTODO COMPLETO</h3>
          ...
          {/* Card 4 - Anexos (Wide) */}
          <div className="md:col-span-7 glass-card p-8 border border-neon-green/30 hover:border-neon-green transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-4xl">📎</span>
              <h3 className="text-2xl font-bold text-text-primary">ANEXOS TÉCNICOS EXCLUSIVOS</h3>
            </div>
        ...
        {/* Badge de Escassez */}
        <div className="glass-card p-8 sm:p-10 border-2 border-danger-red/50 text-center mb-12 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-md mx-auto mb-6">
              <div className="w-full h-4 bg-bg-primary rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-neon-green via-warning-orange to-danger-red rounded-full" style={{ width: '67%' }}></div>
              </div>
              <p className="text-sm text-text-secondary mt-2">67% vendidos</p>
            </div>
        ...
        {/* Card de Preço */}
        <div className="max-w-2xl mx-auto glass-card p-8 sm:p-12 border-2 border-electric-cyan/30 relative hover:border-electric-cyan/60 transition-all duration-300">
          <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 px-6 py-3 glass-card border border-danger-red/50 rounded-full font-bold text-danger-red shadow-lg">
