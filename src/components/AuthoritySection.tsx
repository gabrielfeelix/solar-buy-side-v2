        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <h3 className="text-2xl font-bold">Francis Poloni</h3>
              </div>
              <p className="text-slate-400 text-sm leading-relaxed">
                Atua desde <strong>2018</strong> no setor de integração fotovoltaica e consultoria onde assessorou tanto no lado do <strong>comprador (Buy-Side)</strong> quanto no lado do <strong>vendedor (Sell-Side)</strong>, ajudando na tomada de decisões inteligentes e seguras.
              </p>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-400 text-[10px] font-bold uppercase tracking-widest">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-[#F97316] font-bold tracking-widest text-xs uppercase mb-2">Especialista</p>
                <h3 className="text-2xl font-bold">Ovídio Collesi</h3>
              </div>
              <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-900/30 border border-orange-500/30 text-orange-400 text-[10px] font-bold uppercase tracking-widest">
