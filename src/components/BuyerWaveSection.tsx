    ...
    <section className="bg-[#F5F5F7] text-[#1D1D1F] font-sans antialiased">
      ...
      <div className="py-16 px-6 bg-[#FBFBFD]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-[3rem] overflow-hidden border border-[#E5E5E7] shadow-[0_20px_60px_rgba(0,0,0,0.03)] flex flex-col md:flex-row md:h-[400px]">
            <div className="w-full md:w-[38%] relative h-[360px] md:h-auto">
              ...
              />
              <div className="absolute bottom-2 left-6 right-6 md:bottom-4 md:left-8 md:right-8 backdrop-blur-xl bg-white/20 border border-white/30 px-4 py-2 md:px-6 md:py-2 rounded-2xl text-white shadow-2xl">
